...
import { PROGRAMMES, DOMAIN_COLORS } from '../../data/programmes.js'
...
export function ProgrammeShowcase() {
  ...
  return (
    <section ref={scope} className="cdt-lively relative overflow-hidden bg-paper py-24 dark:bg-ink" data-track-section="tracks">
