...
export function CTABand() {
  ...
  return (
    <section ref={scope} className="bg-paper px-5 pb-24 pt-2 lg:px-8 dark:bg-ink" data-track-section="cta">
      <div
        data-reveal
        ...
        <div className="relative mx-auto max-w-3xl">
          ...
          <div className="mt-9 flex flex-wrap items-center justify-center gap-4">
            <span ref={magRef} className="inline-block">
              <Button size="lg" variant="neon" onClick={() => openRegistration('cta')}>
                Start my internship
                <ArrowRight size={17} />
              </Button>
            </span>
