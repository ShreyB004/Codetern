...
export function Hero() {
  ...
  return (
    <section ref={scope} className="relative overflow-hidden bg-paper text-ink dark:bg-ink dark:text-paper" data-track-section="hero">
      {/* backdrop */}
      ...
      <div className="relative mx-auto grid max-w-7xl items-center gap-14 px-5 pb-24 pt-16 lg:grid-cols-[1.1fr_1fr] lg:px-8 lg:pt-24">
        ...
        <div data-reveal>
          ...
          <div className="mt-9 flex flex-wrap items-center gap-4">
            <Button size="lg" variant="neon" onClick={() => openRegistration('hero')}>
