...
const base =
  'inline-flex items-center justify-center gap-2 rounded-full font-semibold transition-all duration-300 will-change-transform focus-ring'

const variants = {
  primary: 'bg-ink text-paper hover:bg-ink-soft shadow-card hover:shadow-float relative overflow-hidden shine disabled:hover:bg-ink',
  ...
  ghost: 'border border-ink/15 dark:border-paper/15 bg-transparent text-ink hover:border-ink/40 hover:bg-ink/5 dark:bg-paper/5 disabled:hover:bg-transparent disabled:dark:hover:bg-transparent',
